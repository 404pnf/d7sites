						  ...
						  $baomingInfo= $query
							  ->entityCondition('entity_type', 'node')
								->entityCondition('bundle', 'schoolinfo')
								 ->fieldCondition('field_baoming_confirm', 'value',1, '=')	
							->execute();
							...
							$schoolinfo_term_ids ='';
							$i=1;
							foreach($schoolinfo_nids as $schoolinfo_nid){
								$schoolinfo_items = node_load($schoolinfo_nid);
								...
								if($i==1){
										...
										$schoolinfo_term_ids =  $schoolinfo_term_id ;
										
										}else{

										$schoolinfo_term_ids = $schoolinfo_term_ids .'+'.$schoolinfo_term_id;
									
									}

								$i++;
							}
						//print $schoolinfo_term_ids ;
			             $views_name = 'baoming';
                        $display_id = 'testcenter';						
                         print views_embed_view($views_name, $display_id,$schoolinfo_term_ids);
					 ?>
